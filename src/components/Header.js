    ...
    render() {
        ...
        return <section id="app" onMouseMove={this.onMouseMove.bind(this)} style={sectionStyle}>
            <h1 className="middle" ref="section">
                Welcome to <span className="bold" ref="playword_1" style={boldStyle}>Blackjack</span>.<br/>
                And this is here to <span className="bold" ref="playword_2" style={boldStyle}>stay</span>.
				</h1>
        </section>
    }
}
